package com.etong.pt.api.user.facade;
 ...
 */
public interface PtUserRestService {
    /**发送手机验证码*/
    PtResult sendCode(String phone);
    /**验证手机验证码*/
    PtResult verifyCode(String phone, String verify, Boolean flag);
    /**注册*/
